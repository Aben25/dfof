...
class LightModeColors {
  ...
  // Additional Aura-inspired colors
  static const lightGradientStart = Color(0xFF6366F1);
  static const lightGradientEnd = Color(0xFF8B5CF6);
...
class DarkModeColors {
  ...
  static const darkOnTertiary = Color(0xFF3C1A78);
  static const darkError = Color(0xFFF87171);
  static const darkOnError = Color(0xFF7F1D1D);
  static const darkErrorContainer = Color(0xFFA91A1A);
  ...
  // Additional Aura-inspired colors
  static const darkGradientStart = Color(0xFFA5B4FC);
  static const darkGradientEnd = Color(0xFFC4B5FD);
